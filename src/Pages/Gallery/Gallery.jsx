    ...
    return (
        <div className='bg-[#ecf4fb]'>
            <div className='pt-14 pb-10'>
                <h2 className='text-center text-4xl font-extrabold pb-6 text-[#dc2626]' style={{textShadow: "2px 2px 4px #000000"}}>Photo <span className="text-[#fcd34d]">Gallery</span> </h2>
