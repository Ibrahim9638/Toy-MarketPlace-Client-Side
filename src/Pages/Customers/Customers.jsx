      ...
      <div className="pt-6 pb-6 bg-[#ecf4fb]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
            <div className="space-y-4 text-center">
                ...
                <p className="text-lg pl-2">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque repellendus commodi fuga laudantium iusto, sequi quo ab quas perferendis? Odio?</p>
